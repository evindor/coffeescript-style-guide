# CoffeeScript. Руководство по стилю.

В этих правилах представлена коллекция лучших практик и соглашений по программированию на языке программирования [CoffeeScript][coffeescript].

Руководство предназанчено для расширения сообществом разработчиков, и Ваш вклад крайне приветствуется.
